...
"""Recolor the official Krusader SVG to KDE Breeze Dark palette and emit:
   ...
   - .github/assets/icon.png                  (512x512, container/CA icon —
     TRANSPARENT background: the Breeze frame + blue panes read fine on the dark
     CA page, and a white box around the rounded icon looked worse — user call)
...
# ---- Render icon (512x512, TRANSPARENT background — the rounded Breeze frame +
# blue panes read fine on the dark CA page; a white box around it looked worse) ----
